...
function backupDatabase()
{
    ...
    try {
        ...
        foreach ($tables as $table) {
            ...
            // OPTIMIZED: Batch get CREATE TABLE and data together in single iteration
            ...
            if (count($rows) > 0) {
                ...
                // Process all rows from the single fetch - no additional queries in this loop
                foreach ($rows as $row) {
